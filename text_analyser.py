...
def analyse_text(filename):
    """Calculate the number of lines and chars ina file.
    ...
    Returns: A tuple where the first element is the number of lines in the file and the second
            element is the number of characters.
    """
    lines = 0
    chars = 0
