...
def write_grayscale(filename, pixels):
    ...
    Args:
        ...
        pixels: A rectangualr image stored as a sequence of rows.
...
def dimensions(filename):
    ...
    :return: a tuple containing 2 integers with the width & height in pixels.
    Raises: ValueError: If the files was not a BMP file.
    """
